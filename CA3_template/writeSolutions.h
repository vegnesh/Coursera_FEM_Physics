...
void writeSolutionsToFileCA3(const Vector<double>& U, std::string solutionTag){
  hid_t file_id, dataset_id, dataspace_id;
  herr_t      status;
  hsize_t dimens_1d;
  std::cout << "writing solution for Coding Assignment 3 to file : " << solutionTag.c_str() << ".h5" << std::endl;
